...
- DNS records
  ...
  - `Alias record` - similar to CName, but can't be used for naked domain name (zone apex record)
...
- Routing policies
  - simple, weighted, latency-based, failover, geolocation, geoproximity, multivalue routing
